...
import { Currency, CurrencyAmount, Pair, Percent, Token } from '@sarcoinswap/aptos-swap-sdk'
import { AddIcon, AutoColumn, Button, InjectedModalProps, RowBetween, RowFixed, Text } from '@sarcoinswap/uikit'
import { ConfirmationModalContent, TransactionErrorContent } from '@sarcoinswap/widgets-internal'
