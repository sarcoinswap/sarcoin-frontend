...
import sarcoinPoolRelatedQueries from 'components/Pools/utils/sarcoinPoolRelatedQueries'
import useActiveWeb3React from 'hooks/useActiveWeb3React'
import StakeModalContainer from './StakeModalContainer'

const SarcoinStakeModal = ({ pool, ...rest }: Pool.StakeModalPropsType<Coin>) => {
...
export default SarcoinStakeModal
