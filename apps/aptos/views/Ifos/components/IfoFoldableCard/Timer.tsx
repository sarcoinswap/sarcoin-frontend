...
import { Flex, Heading, PocketWatchIcon, Text, Skeleton, TimerIcon, useTooltip } from '@sarcoinswap/uikit'
import getTimePeriods from '@sarcoinswap/utils/getTimePeriods'
