...
import { Box, Flex, IfoSkeletonCardDetails, Skeleton, Text, TooltipText, useTooltip } from '@sarcoinswap/uikit'
import { formatNumber, getBalanceNumber } from '@sarcoinswap/utils/formatBalance'
import { DAY_IN_SECONDS } from '@sarcoinswap/utils/getTimePeriods'
