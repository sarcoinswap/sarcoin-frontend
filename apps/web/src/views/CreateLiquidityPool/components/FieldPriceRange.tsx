import { MAX_BIN_STEP, MIN_BIN_STEP } from '@sarcoinswap/infinity-sdk'
import { useTranslation } from '@sarcoinswap/localization'
import { AutoColumn, Box, BoxProps, DynamicSection, PreTitle, RowBetween } from '@sarcoinswap/uikit'
