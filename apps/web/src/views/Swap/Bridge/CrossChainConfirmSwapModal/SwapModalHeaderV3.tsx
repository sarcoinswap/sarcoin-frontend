...
import { Currency, CurrencyAmount, Percent, TradeType } from '@sarcoinswap/sdk'
import { AutoColumn, Button, ErrorIcon, Text } from '@sarcoinswap/uikit'
...
import { DualCurrencyDisplay } from '@sarcoinswap/widgets-internal'
