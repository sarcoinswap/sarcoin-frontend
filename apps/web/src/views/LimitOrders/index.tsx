...
import { Currency, CurrencyAmount, Percent, Token, Trade, TradeType } from '@sarcoinswap/sdk'
import { AutoColumn, BottomDrawer, Box, Button, Flex, Link, useMatchBreakpoints, useModal } from '@sarcoinswap/uikit'
import { Swap as SwapUI } from '@sarcoinswap/widgets-internal'
