...
import { PredictionConfig, PredictionSupportedSymbol, targetChains } from '@sarcoinswap/prediction'
import { Box, Flex, OptionProps, Select, Text } from '@sarcoinswap/uikit'
