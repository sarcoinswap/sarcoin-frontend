...
import { BetPosition, REWARD_RATE } from '@sarcoinswap/prediction'
import { BlockIcon, Box, Flex, Heading, InfoIcon, PrizeIcon, ScanLink, Text, useTooltip } from '@sarcoinswap/uikit'
