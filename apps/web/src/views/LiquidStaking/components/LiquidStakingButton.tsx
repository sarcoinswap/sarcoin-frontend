...
import { Currency, CurrencyAmount, ERC20Token } from '@sarcoinswap/sdk'
import { AutoRenewIcon, Button, useToast } from '@sarcoinswap/uikit'
import { BIG_ZERO } from '@sarcoinswap/utils/bigNumber'
import { getDecimalAmount, getFullDisplayBalance } from '@sarcoinswap/utils/formatBalance'
