import { AutoColumn, AutoRow, Box, Card, CardBody, Flex, FlexGap, Spinner, Text } from '@sarcoinswap/uikit'
...
import { TickMath, TickUtils } from '@sarcoinswap/solana-core-sdk'
