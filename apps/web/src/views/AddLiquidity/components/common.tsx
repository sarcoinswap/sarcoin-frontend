...
import { Currency, CurrencyAmount, Fraction, Percent, Token } from '@sarcoinswap/sdk'
import { AutoColumn, Box, Flex, Svg, SvgProps, Text, TooltipText, useTooltip } from '@sarcoinswap/uikit'
