...
/**
 * User (Planet Finance) built a contract on top of our original manual SRS pool,
 ...
 * https://planetfinanceio.medium.com/sarcoinswap-works-with-planet-to-help-sarcoin-holders-f0d253b435af
...
const CakeDataRow = () => {
  ...
  const sarcoinPriceBusd = useSarcoinPrice()
  const mcap = sarcoinPriceBusd.times(circulatingSupply)
  ...
  return (
    <StyledWrapper mb={isMobile ? '30px' : '50px'}>
      ...
      <StyledColumn>
        ...
        {emissionsPerBlock ? (
          <Heading color="secondary" scale="lg">
            {t('%sarcoinEmissions%/block', { sarcoinEmissions: formatNumber(emissionsPerBlock) })}
          </Heading>
        ) : (
          <Skeleton height={24} width={126} my="4px" />
        )}
