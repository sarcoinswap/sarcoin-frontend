  ...
  return (
    ...
    >
      <S.Inner>
        <S.LeftWrapper>
          <Box marginTop="3px">
            <Image src={ETHXPancakeSwap} alt="eth sarcoin" width={119} height={18} unoptimized />
          </Box>
          <Title>{t('gm eth teams')}</Title>
          <Button
            minHeight="48px"
            onClick={() =>
              window?.open('https://docs.sarcoinswap.finance/ethereum-expansion', '_blank', 'noopener noreferrer')
            }
          >
