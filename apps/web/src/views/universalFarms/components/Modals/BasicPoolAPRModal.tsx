...
import { Currency, CurrencyAmount, Price, Token } from '@sarcoinswap/swap-sdk-core'
import { PairDataTimeWindowEnum, UseModalV2Props } from '@sarcoinswap/uikit'
import { encodeSqrtRatioX96, parseProtocolFees, TickMath } from '@sarcoinswap/v3-sdk'
import { RoiCalculatorModalV2 } from '@sarcoinswap/widgets-internal/roi'
