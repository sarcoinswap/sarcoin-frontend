...
import { Skeleton, Text, Flex, Box, useModal, useMatchBreakpoints, Balance } from '@sarcoinswap/uikit'
import { Pool } from '@sarcoinswap/widgets-internal'

import BigNumber from 'bignumber.js'
import { PoolCategory } from 'config/constants/types'
import { BIG_ZERO } from '@sarcoinswap/utils/bigNumber'
import { formatNumber, getBalanceNumber, getFullDisplayBalance } from '@sarcoinswap/utils/formatBalance'
