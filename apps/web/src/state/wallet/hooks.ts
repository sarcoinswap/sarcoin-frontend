import { ChainId, Currency, CurrencyAmount, Native, Token, UnifiedCurrency, ZERO_ADDRESS } from '@sarcoinswap/sdk'
import { useQuery } from '@tanstack/react-query'
import { isSolana, NonEVMChainId } from '@sarcoinswap/chains'
import { selectedEvmWalletAtom, selectedSolanaWalletAtom } from '@sarcoinswap/ui-wallets/src/state/atom'
import useAccountActiveChain from 'hooks/useAccountActiveChain'
import { useLocalStorage, useWallet } from '@solana/wallet-adapter-react'
import { EvmConnectorNames, SolanaProviderLocalStorageKey, WalletAdaptedNetwork } from '@sarcoinswap/ui-wallets'
...
import { useSelectedWallet } from '@sarcoinswap/ui-wallets/src/state/hooks'
