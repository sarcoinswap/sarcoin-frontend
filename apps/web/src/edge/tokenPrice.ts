...
import { chainlinkOracleCAKE } from '@sarcoinswap/prediction'
import { CurrencyParams, getCurrencyUsdPrice } from '@sarcoinswap/price-api-sdk'
import { Native } from '@sarcoinswap/sdk'
import { OnChainProvider, PoolType, SmartRouter, SmartRouterTrade } from '@sarcoinswap/smart-router'
import { Currency, CurrencyAmount, getCurrencyAddress, TradeType } from '@sarcoinswap/swap-sdk-core'
import { CAKE, STABLE_COIN } from '@sarcoinswap/tokens'
