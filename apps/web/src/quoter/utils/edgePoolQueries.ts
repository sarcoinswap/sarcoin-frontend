...
import { findHook, findHookByAddress, type HookData, hooksList } from '@sarcoinswap/infinity-sdk'
import {
  getPoolAddress,
  InfinityBinPool,
  InfinityClPool,
...
import {
  ...
  RemotePoolBIN,
  RemotePoolCL,
} from '@sarcoinswap/smart-router/dist/evm/infinity-router/queries/remotePool.type'
