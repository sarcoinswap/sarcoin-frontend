...
import { Currency, CurrencyAmount, Pair, Percent } from '@sarcoinswap/sdk'
import { Text, Card, CardBody, Flex, CardProps, TooltipText, useTooltip, Link, AutoColumn } from '@sarcoinswap/uikit'
