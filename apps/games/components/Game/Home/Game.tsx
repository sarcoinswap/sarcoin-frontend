import { GameType, PostersItemData, PostersLayout } from '@sarcoinswap/games'
import { useTranslation } from '@sarcoinswap/localization'
import { Box, Button, Card, CardHeader, Flex, Link, TelegramIcon, Text, useMatchBreakpoints } from '@sarcoinswap/uikit'
