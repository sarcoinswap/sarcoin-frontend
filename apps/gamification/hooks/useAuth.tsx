...
import { LegacyWalletConfig, WalletConnectorNotFoundError, WalletSwitchChainError } from '@sarcoinswap/ui-wallets'
import replaceBrowserHistory from '@sarcoinswap/utils/replaceBrowserHistory'
