...
import SarcoinPrice from "../../components/SarcoinPrice/SarcoinPrice";
  ...
  return (
    <MenuContext.Provider value={providerValue}>
            ...
            <StyledNav>
              ...
              <Flex alignItems="center" height="100%">
                <AtomBox mr="12px" display={{ xs: "none", lg: "block" }}>
                  <SarcoinPrice chainId={chainId} showSkeleton={false} sarcoinPriceUsd={sarcoinPriceUsd} />
                </AtomBox>
                <Box mt="4px">
                  <LangSelector
      ...
      <Footer
        ...
        setLang={setLang}
        currentLang={currentLang}
        sarcoinPriceUsd={sarcoinPriceUsd}
        buySarcoinLabel={buySarcoinLabel}
        buySarcoinLink={buySarcoinLink}
