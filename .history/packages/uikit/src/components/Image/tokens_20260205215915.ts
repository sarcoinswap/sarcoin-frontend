/**
 * @see https://github.com/sarcoinswap/pancake-frontend/blob/develop/src/config/constants/tokens.ts
 */
const tokens = {
  sarcoin: {
    symbol: "SRS",
    address: {
      56: "0xCa127b33F6e606660D8AbA486A4b167fEd4b5612",
      97: "",
    },
    decimals: 18,
    projectLink: "https://sarcoinswap.finance/",
  },
  txl: {
    symbol: "TXL",
    address: {
