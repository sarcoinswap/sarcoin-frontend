...
export interface RoiCalculatorModalProps {
  ...
  rewardCakePerSecond?: boolean;  rewardSarcoinPerSecond?: boolean;  onBack?: () => void;
  onDismiss?: () => void;
  bSarCalculatorSlot?: (stakingTokenBalance: string) => React.ReactNode;
  isLocked?: boolean;
...
const RoiCalculatorModal: React.FC<React.PropsWithChildren<RoiCalculatorModalProps>> = ({
  ...
  rewardSarcoinPerSecond,
  onBack,
  onDismiss,
  bSarcoinCalculatorSlot,
  isLocked = false,
  stableSwapAddress,
  stableLpFee,
    ...
    >
      <ScrollableContainer>
        ...
        <Flex flexDirection="column" mb="8px">
          ...
          {bSarcoinCalculatorSlot && bSarcoinCalculatorSlot(principalAsToken)}
          {autoCompoundFrequency === 0 && (
            <>
              <Text mt="24px" color="secondary" bold fontSize="12px" textTransform="uppercase">
                {t("Compounding every")}
      ...
      <RoiCalculatorFooter
        ...
        linkHref={linkHref}
        performanceFee={performanceFee}
        rewardSarcoinPerSecond={rewardSarcoinPerSecond}
        isLocked={isLocked}
