...
const FarmV3CardList: React.FunctionComponent<React.PropsWithChildren<FarmV3CardListProps>> = ({
  ...
  const { stakedPositions, unstakedPositions, lpSymbol, token, quoteToken, pendingSarcoinByTokenIds, multiplier } = farm
              ...
              .map((position) => (
                <>
                  <SingleFarmV3Card
                    ...
                    pendingSarcoinByTokenIds={pendingSarcoinByTokenIds}
                    onDismiss={onDismiss}
                  />
                </>
              ))}
