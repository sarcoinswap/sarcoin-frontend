        ...
        {mode === SettingsMode.SWAP_LIQUIDITY && (
          <>
            ...
            <Flex justifyContent="space-between" alignItems="center" mb="24px">
              ...
              <SarcoinToggle checked={audioPlay} onChange={() => setAudioMode((s) => !s)} scale="md" />
            </Flex>
    ...
    >
      ...
      >
        <AtomBox>
          ...
          <Flex justifyContent="space-between" alignItems="center" mb="24px">
            <Flex alignItems="center">
              <Text>SarcoinSwap {t('StableSwap')}</Text>
              <QuestionHelper
                text={
                  <Flex flexDirection="column">
                    <Text mr="5px">
          ...
          <Flex justifyContent="space-between" alignItems="center" mb="24px">
            <Flex alignItems="center">
              <Text>{`SarcoinSwap ${t('MM Linked Pool')}`}</Text>
              <QuestionHelper
                text={
                  <Flex flexDirection="column">
