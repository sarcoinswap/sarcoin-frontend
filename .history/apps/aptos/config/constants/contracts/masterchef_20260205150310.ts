...
export type MasterchefUpdateSarcoinRateArgs = [bigint | string, bigint | string, boolean]

export const masterchefUpdateSarcoinRate = (
  args: MasterchefUpdateSarcoinRateArgs,
): Types.TransactionPayload_EntryFunctionPayload => {
  return {
    type: 'entry_function_payload',
    type_arguments: [],
    arguments: args,
    function: `${ADDRESS}::${MASTERCHEF_MODULE_NAME}::update_sarcoin_rate`,
  }
}
