...
const getTokenLogoURL = memoize(
  (token?: Token) => {
    if (token && token.chainId === ChainId.MAINNET) {
      return `https://tokens.sarcoinswap.finance/images/aptos/${token.address}.png` // hex encoding
    }
    return null
  },
...
const APT_SRCS = ['https://tokens.sarcoinswap.finance/images/symbol/apt.png']
